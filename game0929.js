...
function preload() {
    ...
    this.load.image('player', 'images/player.png');
    this.load.image('player02', 'images/player02.png');
    this.load.image('impact', 'images/impact.png');
    this.load.image('rule', 'images/rule.png'); // 預載入遊戲規則背景圖
}
...
function create() {
    ...
    // 監聽滑鼠按下事件，切換到player02.png
    this.input.on('pointerdown', function () {
        this.player.setTexture('player02'); // 切換到player02.png
    }, this);

    // 監聽滑鼠放開事件，切換回player.png，並播放impact特效
    this.input.on('pointerup', function () {
        this.player.setTexture('player'); // 切換回player.png
        this.showImpact(); // 播放impact特效
    }, this);
}
